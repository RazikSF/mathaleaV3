<script lang="ts">
  ...
  async function updateDisplay() {
    if (exercice.typeExercice === "simple")
      Mathalea.handleExerciceSimple(exercice, isInteractif);
    ...
    <div class="flex flex-col-reverse lg:flex-row">
      ...
      >
                  ...
                  <div>
                    <li
                      style={i < exercice.listeQuestions.length
                        ? `margin-bottom: ${exercice.spacing}`
                        : ""}
                    ...
                    <div
                      class="bg-gray-200"
                      style="line-height: {Math.max(
                        3,
                        exercice.spacingCorr * 2
                      )}em;"
                      id="correction${indiceExercice}Q${i}"
                    >
                      {@html Mathalea.formatExercice(
          ...
          {:else}
            ...
            <div style="columns: {columnsCount.toString()}">
              ...
              >
                ...
                <div>
                  <li
                    style="line-height: {Math.max(3, exercice.spacing * 2)}em;"
                    id="exercice{indiceExercice}Q${i}"
                  >
                    {@html Mathalea.formatExercice(item)}
                  </li>
        ...
        {#if isInteractif && !isCorrectionVisible && isContentVisible}
          <button type="submit" on:click={verifExercice} bind:this={buttonScore}
