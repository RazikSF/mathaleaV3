...
<div class="mx-2 mb-2">
    <form class="nosubmit">
        <input type="text" style="margin-top: 20px; color: #888888; font-size: 16px; border-radius: 5px; margin-left: auto; margin-right: auto; display: block; background-color: white;"
               placeholder="Rechercher..." class="nosubmit border-transparent focus:border-none focus:outline-0 focus:ring-0" bind:value={inputSearch} />
    </form>
</div>
